    ...
    return (
        <div>
            ...
            <div style={{textIndent: 30, fontStyle: "italic", backgroundColor: (props.step === 3)?"yellow" : "white"}}>j &#8592; &#8970;log<sub>2</sub>(min{"{k(w) - k(v), d(w)}"})&#8971; </div>
                <div style={{textIndent: 30, backgroundColor: (props.step === 4)?"yellow" : "white"}}><a style={{fontWeight: "bold"}}>if</a> <span style={{fontStyle: "italic",}}>d(w) = 2<sup>j</sup></span> <a style={{fontWeight: "bold"}}>then</a></div>
            ...
            <div style={{textIndent: 30, fontStyle: "italic", backgroundColor: (props.step === 7)?"yellow" : "white"}}>insert((v, w), out(v))</div>
                <div style={{textIndent: 30, backgroundColor: (props.step === 8)?"yellow" : "white"}}><a style={{fontWeight: "bold"}}>return</a><span style={{fontStyle: "italic",}}>{" False"}</span></div>
            ...
            <div style={{textIndent: 15, fontStyle: "italic", backgroundColor: (props.step === 9)?"yellow" : "white"}}>T &#8592; {"{(v, w)}"}</div>
                <div style={{textIndent: 15, backgroundColor: (props.step === 10)?"yellow" : "white"}}><a style={{fontWeight: "bold"}}>while</a><span style={{fontStyle: "italic",}}> T &#8800; &#8709; </span><a style={{fontWeight: "bold"}}>do</a></div>
            <div style={{textIndent: 30, fontStyle: "italic", backgroundColor: (props.step === 10)?"yellow" : "white"}}>(x, y) &#8592; pop(T) </div>
                <div style={{textIndent: 30, backgroundColor: (props.step === 12)?"yellow" : "white"}}><a style={{fontWeight: "bold"}}>if</a> PruchodHranou(<span style={{fontStyle: "italic",}}>x, y, T, v</span>) <a style={{fontWeight: "bold"}}>then</a></div>
                <div style={{textIndent: 45, backgroundColor: (props.step === 12)?"yellow" : "white"}}><a style={{fontWeight: "bold"}}>return</a><span style={{fontStyle: "italic",}}>{" True"}</span></div>
            <div style={{textIndent: 30}}><a style={{fontWeight: "bold"}}>end if </a></div>
